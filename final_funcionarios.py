...
class funcs():
    ...
    def new_funcionario(self):
        ...
        self.conecta_bd()
        self.clean_tela()
        dados = " INSERT INTO funcionarios (bi, nome, telefone, morada) VALUES (%s, %s, %s, %s)"
    ...
    def select_lista(self):
        ...
        self.conecta_bd()
        self.cursor.execute(" SELECT bi, nome, telefone, morada FROM funcionarios ORDER BY nome ASC; ")
    ...
    def delete_funcionario(self):
        ...
        self.conecta_bd() 
        print(self.bi)
        dados2 = "DELETE FROM funcionarios WHERE bi = {}" .format(self.bi)
        self.cursor.execute(dados2)
        self.conn.commit()
        self.desconecta_db()
        self.clean_tela()
        self.select_lista()
    def alter_funcionario(self):
        self.variaveis()
        self.conecta_bd()
        dados = "UPDATE funcionarios SET bi = %s, nome = %s, telefone = %s, morada = %s"
        self.cursor.execute( dados, (self.bi, self.nome, self.telefone, self.morada))
        self.conn.commit()
        self.desconecta_db()
        self.select_lista()
    ...
    def search_funcionario(self):
        ...
        self.cursor.execute("""SELECT bi, nome, telefone, morada FROM funcionarios WHERE bi LIKE '%s' ORDER BY bi ASC""" % bi)
...
class application(funcs):
    ...
    def tela(self):
        ...
        self.funcionarios.configure(background= '#1e3743')
        self.funcionarios.geometry("800x600")
        self.funcionarios.resizable(True, True)
        self.funcionarios.maxsize(width= 1000, height= 800)
        self.funcionarios.minsize(width= 400, height= 300)
    def frames_da_tela(self):
        self.frame_1 = Frame(self.funcionarios, bd = 4, bg = '#dfe3ee',
                             highlightbackground= '#759fe6', highlightthickness= 3)
        self.frame_1.place(relx= 0.02, rely= 0.02, relwidth= 0.96, relheight= 0.46)

        self.frame_2 = Frame(self.funcionarios, bd = 4, bg = '#dfe3ee',
                             highlightbackground= '#759fe6', highlightthickness= 3)
    ...
    def widgets_frame1(self):
        ...
        self.bt_search = Button(self.frame_1, text= "SEARCH", bd= 2, bg= '#107db2', fg= 'white', font= ('verdana', 8, 'bold'), command= self.search_funcionario)
        self.bt_search.place(relx= 0.3, rely= 0.1, relwidth= 0.1, relheight= 0.15)

         ### criação do botão NEW
        self.bt_new = Button(self.frame_1, text= "NEW", bd= 2, bg= '#107db2', fg= 'white', font= ('verdana', 8, 'bold'), command= self.new_funcionario)
        self.bt_new.place(relx= 0.6, rely= 0.1, relwidth= 0.1, relheight= 0.15)

        ### criação do botão ALTER
        self.bt_alter = Button(self.frame_1, text= "ALTER", bd= 2, bg= '#107db2', fg= 'white', font= ('verdana', 8, 'bold'), command= self.alter_funcionario)
        self.bt_alter.place(relx= 0.7, rely= 0.1, relwidth= 0.1, relheight= 0.15)
        
        ### criação do botão DELETE
        self.bt_delete = Button(self.frame_1, text= "DELETE", bd= 2, bg= '#107db2', fg= 'white', font= ('verdana', 8, 'bold'), command= self.delete_funcionario)
